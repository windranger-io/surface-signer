...
const Container = tw.div`h-auto items-center px-5 py-10 text-lg`
...
const Instructions = ({}: InstructionsProps) => {
  ...
  const [session, setSession] = useState<{ 
    ...
    verifyMessage: (msg: string, sig: string, del: string, delSig: string) => Promise<Record<string, unknown>>
  } | false>();
  ...
  return (
    <Container>
      ...
      <div className="block list-disc list-inside">
        <li>Install the extension by naviagating to <code>chrome://extensions</code> (copy and paste, we can&apos;t link to this page)</li>
      </div>
      <div className="block list-disc list-inside">
